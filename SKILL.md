---
name: tracemark
description: Generate artistic commemorative seal/postcard imagery from a photo and a one-line theme, in three cultural tracks (Chinese zhuan seal, Japanese craft stamp, Western wax seal). Trigger when the user wants to: add a decorative seal or stamp to a photo or postcard; turn a photo into a postcard with an artistic seal; generate a seal-style graphic for a journal, gift, or social post; create monogram or wax-seal-style ornament. Do NOT use for: real/official seals, authentication stamps, documents needing legal validity, copying existing trademarks. Always run scripts/validate_input.py before rendering. Read AUP.md first. Follow research/*.md for cultural design rules.
---
